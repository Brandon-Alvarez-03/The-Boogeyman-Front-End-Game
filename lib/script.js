...
window.addEventListener("load", () => {
  ...
  class Obstacle {
    constructor(gameWidth, gameHeight) {
      ...
      this.speed = 12; // rate at which obstacles approach Laurie // could possibly have difficulty where its random and another whhere it's constant
      this.toDelete = false;
    }
    draw(context) {
      context.drawImage(
  ...
  // function displayStatusText(displayTime) {
  //   document.querySelector("h1").innerText = displayTime;
  //   displayTime--;
  // }
  ...
  let randomSpawnInterval = Math.random() * 1000 + 1000;
